...
public class PointInPolygon {
  public String testPoint(String[] vertices, int testPointX, int testPointY) {
    ...
    for (int i = 0; i < vertices.length; ++i) {
      ...
      if (a.x == b.x
          && testPointY >= Math.min(a.y, b.y)
          && testPointY < Math.max(a.y, b.y)
          && testPointX < a.x) {
        ++intersectCount;
      }
    }
  ...
  boolean isOnSegment(Point a, Point b, int testPointX, int testPointY) {
    return (a.x == b.x)
        ? (testPointX == a.x
            ...
            && testPointY <= Math.max(a.y, b.y))
        : (testPointY == a.y
            && testPointX >= Math.min(a.x, b.x)
            && testPointX <= Math.max(a.x, b.x));
  }
  ...
  public static void main(String[] args) {
    ...
    p0 =
        new String[] {
          "1 0", "2 0", "2 1", "3 1", "3 0", "4 0", "4 -1", "5 -1", "5 0", "6 0", "6 2", "0 2",
          "0 3", "-1 3", "-1 4", "0 4", "0 6", "1 6", "1 7", "0 7", "0 8", "-2 8", "-2 2", "-8 2",
          "-8 0", "-7 0", "-7 -1", "-6 -1", "-6 0", "-4 0", "-4 1", "-3 1", "-3 0", "-2 0", "-2 -6",
          "0 -6", "0 -5", "1 -5", "1 -4", "0 -4", "0 -3", "-1 -3", "-1 -2", "0 -2", "0 -1", "1 -1"
        };
    p1 = 0;
    p2 = 0;
    p3 = "INTERIOR";
