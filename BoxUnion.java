...
public class BoxUnion {
  ...
  public int area(String[] rectangles) {
    ...
    if (rectangles.length == 2) {
      ...
      result +=
          computeIntersect(computeIntersect(rects[0], rects[1]), rects[2]).computeArea()
  ...
  Rectangle computeIntersect(Rectangle rect1, Rectangle rect2) {
    return new Rectangle(
        Math.max(rect1.minX, rect2.minX),
        Math.max(rect1.minY, rect2.minY),
        Math.min(rect1.maxX, rect2.maxX),
        Math.min(rect1.maxY, rect2.maxY));
  }
