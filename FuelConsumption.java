...
public class FuelConsumption {
  public double maximalDistance(int[] velocities, int[] consumptions, int fuel) {
    return IntStream.range(0, velocities.length)
        .mapToDouble(i -> (double) fuel / consumptions[i] * velocities[i])
        .max()
        .getAsDouble();
  }
  ...
  public static void main(String[] args) {
    ...
    p0 =
        new int[] {
          240, 195, 130, 133, 15, 160, 111, 206, 72, 149, 146, 115, 235, 183, 102, 96, 163, 61, 196,
          52, 87, 139, 33, 7, 90, 67, 118, 227, 197, 114
        };
    p1 =
        new int[] {
          14837, 2981, 17292, 18591, 4832, 7461, 17991, 18369, 18291, 9400, 15179, 3317, 2595, 2441,
          6936, 8028, 14973, 18981, 12503, 7816, 2883, 6385, 6230, 18157, 16567, 9310, 2866, 4687,
          14171, 4477
        };
    p2 = 31710;
