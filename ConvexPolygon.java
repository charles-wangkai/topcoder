...
public class ConvexPolygon {
  public double findArea(int[] x, int[] y) {
    return Math.abs(
            IntStream.range(0, x.length)
                .mapToLong(i -> x[i] * y[(i + 1) % x.length] - x[(i + 1) % x.length] * y[i])
                .sum())
        / 2.0;
  }
  ...
  public static void main(String[] args) {
    ...
    p0 =
        new int[] {
          -6010, -7937, -8782, -9506, -9654, -9852, -9854, -9998, -9999, -9996, -9901, -9811, -9444,
          -8798, -8580, -2085, 6842, 8339, 9827, 9946, 9993, 9959, 9940, 9855, 9657, 8504, 8262,
          7552, 6326, 5537, 4723
        };
    p1 =
        new int[] {
          -9976, -9947, -9873, -9739, -9654, -8501, -8475, -5009, 475, 4926, 7078, 8673, 9417, 9785,
          9820, 9974, 9986, 9979, 9862, 9211, -5070, -6599, -7121, -8624, -8912, -9710, -9766,
          -9863, -9914, -9941, -9962
        };
    p2 = 3.939960635E8D;
