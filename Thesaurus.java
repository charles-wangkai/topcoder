...
public class Thesaurus {
	public String[] edit(String[] entry) {
		List<Set<String>> groups = Arrays.stream(entry)
				.map(e -> Arrays.stream(e.split(" ")).collect(Collectors.toSet())).collect(Collectors.toList());
		...
		return combined.stream().map(g -> g.stream().sorted().collect(Collectors.joining(" "))).sorted()
				.toArray(String[]::new);
	}
	...
	public static void main(String[] args) {
		...
		// ----- test 3 -----
		p0 = new String[] { "point run score", "point dot", "cut run tear score", "cut valley", "cute pretty" };
