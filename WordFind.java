...
public class WordFind {
    ...
    for (int r = 0; r < grid.length; ++r) {
      for (int c = 0; c < grid[0].length(); ++c) {
        if (isMatched(grid, word, r, c, 0, 1)
            || isMatched(grid, word, r, c, 1, 0)
            || isMatched(grid, word, r, c, 1, 1)) {
  ...
  boolean isMatched(String[] grid, String word, int beginR, int beginC, int offsetR, int offsetC) {
