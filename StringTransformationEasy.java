...
public class StringTransformationEasy {
	public String getResult(String s, String t) {
		...
		return (s.charAt(0) == t.charAt(0) && sCounts.size() == tCounts.size()
				&& ((sCounts.size() == 1 && sCounts.get(0).equals(tCounts.get(0)))
						|| (sCounts.size() != 1 && IntStream.range(0, sCounts.size()).allMatch(
								i -> sCounts.get(i) >= tCounts.get(i) && (sCounts.get(i) - tCounts.get(i)) % 2 == 0))))
										? "YES"
										: "NO";
	}
