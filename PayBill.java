...
public class PayBill {
  public int[] whoPaid(int[] meals, int totalMoney) {
    ...
    long[] people_ = people;
    return IntStream.range(0, meals.length)
        .filter(i -> ((people_[totalMoney] >> i) & 1) == 1)
        .toArray();
  }
  ...
  public static void main(String[] args) {
    ...
    p0 =
        new int[] {
          6584, 6733, 6018, 5840, 2723, 4902, 4260, 5375, 6745, 1234, 3000, 8222, 2472, 4348, 1716,
          9995, 415, 1234, 2345, 5679
        };
    p1 = 70630;
    ...
    p0 =
        new int[] {
          9560, 6506, 597, 415, 4067, 5665, 7585, 8551, 4846, 263, 5486, 2275, 3902, 4915, 8570,
          4393, 5940, 6126, 5457, 4672, 4781, 3064, 6767, 6877, 2261, 843, 5279, 8295, 9639, 6306,
          8587, 1772, 1508, 6309, 4255, 240, 2193, 8495, 7474, 3749, 4663, 4582, 1219, 9004, 1938
        };
    p1 = 6642;
