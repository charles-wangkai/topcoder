...
public class HiddenNumbers {
	public String[] findAll(String[] text) {
		...
		Collections.sort(numbers, (n1, n2) -> {
			long v1 = Long.parseLong(n1);
			long v2 = Long.parseLong(n2);
			if (v1 != v2) {
		...
		return numbers.subList(numbers.size() / 2, numbers.size()).toArray(new String[0]);
	}
	...
	public static void main(String[] args) {
		...
		// ----- test 0 -----
		p0 = new String[] { "098m03r9f80239802389f0m9KDKLKLJDKLJm0983m890DMOm03",
				"dlkfj3hljf4h3klhl  4j4 444 44  rjhkrrkr34534539893",
				" 390804980498409480 dkldjkl djkl djkl d00000002998" };
		p1 = new String[] { "9", "44", "098", "444", "890", "0983", "00000002998", "34534539893", "80239802389",
				"390804980498409480" };
		all_right = KawigiEdit_RunTest(0, p0, true, p1) && all_right;
		// ------------------

		// ----- test 1 -----
		p0 = new String[] { "39 000220 30 skldjdije939939slkk 3090 2912kjdk3949",
