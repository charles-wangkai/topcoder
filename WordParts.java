...
public class WordParts {
	public int partCount(String original, String compound) {
		String[] parts = Stream
				.concat(IntStream.rangeClosed(1, original.length()).mapToObj(i -> original.substring(0, i)),
		...
		return (minPartNums[compound.length()] != Integer.MAX_VALUE) ? minPartNums[compound.length()] : -1;
	}
