...
public class grafixGlobs {
	static final Map<String, Integer> OBJ_TO_INDEX = new HashMap<>();
	static {
		OBJ_TO_INDEX.put("arc", 0);
		OBJ_TO_INDEX.put("circle", 1);
		OBJ_TO_INDEX.put("polygon", 2);
	}
	...
	public static void main(String[] args) {
		...
		// ----- test 0 -----
		p0 = new String[] { "make polygon", "make circle", "make polygon", "merge 0 1", "merge 2 0", "split 2" };
		p1 = 0;
		p2 = new int[] { 0, 1, 0 };
		...
		// ----- test 1 -----
		p0 = new String[] { "make circle", "make circle", "make arc", "merge 2 1", "delete 0", "split 2", "delete 0",
				"make polygon" };
		p1 = 0;
		p2 = new int[] { 0, 0, 1 };
		...
		// ----- test 4 -----
		p0 = new String[] { "make polygon", "make polygon", "make arc", "make circle", "make circle", "delete 3",
				"make polygon", "make arc", "make arc", "merge 1 3", "merge 1 4", "merge 2 1", "make arc", "make arc",
