...
public class UserName {
	...
	public static void main(String[] args) {
		...
		// ----- test 1 -----
		p0 = new String[] { "MasterOfDisaster", "TygerTyger1", "DingBat", "Orpheus", "TygerTyger", "WolfMan",
				"MrKnowItAll" };
		p1 = "TygerTyger";
		p2 = "TygerTyger2";
		...
		// ----- test 2 -----
		p0 = new String[] { "TygerTyger2000", "TygerTyger1", "MasterDisaster", "DingBat", "Orpheus", "WolfMan",
				"MrKnowItAll" };
		p1 = "TygerTyger";
		p2 = "TygerTyger";
		...
		// ----- test 3 -----
		p0 = new String[] { "grokster2", "BrownEyedBoy", "Yoop", "BlueEyedGirl", "grokster", "Elemental", "NightShade",
				"Grokster1" };
		p1 = "grokster";
		p2 = "grokster1";
		...
		// ----- test 4 -----
		p0 = new String[] { "Bart4", "Bart5", "Bart6", "Bart7", "Bart8", "Bart9", "Bart10", "Lisa", "Marge", "Homer",
