public class OldestOne {
	...
	public static void main(String[] args) {
		...
		// ----- test 1 -----
		p0 = new String[] { "DOUG JONES 102 213 ALDEN LANE", "   BOB     A SMITH  102 CLARK ST", "A 1 999ELM" };
		p1 = "DOUG JONES";
		all_right = KawigiEdit_RunTest(1, p0, true, p1) && all_right;
		// ------------------

		// ----- test 2 -----
		p0 = new String[] { "DOUG JONES 122 213 ALDEN LANE", "   BOB     A SMITH  102 CLARK ST", "A 199 ELM" };
		p1 = "A";
		all_right = KawigiEdit_RunTest(2, p0, true, p1) && all_right;
		// ------------------

		// ----- test 3 -----
		p0 = new String[] { "   DOUG                 JONES   122 213 ALDEN LANE",
				"   BOB     A SMITH                       102  3", " J O H N N Y           199 ELM" };
		p1 = "J O H N N Y";
