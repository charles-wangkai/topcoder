...
public class Aaagmnrs {
	...
	String buildKey(String phrase) {
		return phrase.toLowerCase().replaceAll(" ", "").chars().sorted().mapToObj(ch -> String.valueOf((char) ch))
	...
	public static void main(String[] args) {
		...
		// ----- test 2 -----
		p0 = new String[] { "Radar ghost jilts Kim", "patched hers first", "DEPTH FIRST SEARCH",
				"DIJKSTRAS ALGORITHM" };
