...
public class Untypeset {
	...
	int eval(String[] expression, int minR, int maxR, int minC, int maxC) {
		...
		for (int c = minC + 1; c < maxC; ++c) {
			if (isPlus(expression, minR, maxR, c)) {
				return eval(expression, minR, maxR, minC, c - 1) + eval(expression, minR, maxR, c + 1, maxC);
			}
		}
		...
		for (int r = minR + 1;; ++r) {
			if (isDiv(expression, minC, maxC, r)) {
				return eval(expression, minR, r - 1, minC, maxC) / eval(expression, r + 1, maxR, minC, maxC);
			}
		}
	}
	...
	public static void main(String[] args) {
		...
		// ----- test 3 -----
		p0 = new String[] { "   120   ", "  -----  ", "    10   ", "---------", "    6    ", "   ---   ", "    2    " };
		p1 = 4;
		all_right = KawigiEdit_RunTest(3, p0, true, p1) && all_right;
		// ------------------

		// ----- test 4 -----
		p0 = new String[] { "       24       ", " 31 + ----      ", "       12   + 16", "-----------     ",
				"   5 + 6        " };
		p1 = 19;
