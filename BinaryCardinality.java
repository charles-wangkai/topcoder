...
public class BinaryCardinality {
  ...
  public static void main(String[] args) {
    ...
    p0 =
        new int[] {
          811385, 340578, 980086, 545001, 774872, 855585, 13848, 863414, 419523, 190151, 784903,
          127461
        };
    p1 =
        new int[] {
          13848, 340578, 545001, 855585, 419523, 811385, 127461, 190151, 774872, 863414, 784903,
          980086
        };
