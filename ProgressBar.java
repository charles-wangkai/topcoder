...
public class ProgressBar {
	...
	public String showProgress(int[] taskTimes, int tasksCompleted) {
		int completedBlockNum = 20 * IntStream.range(0, tasksCompleted).map(i -> taskTimes[i]).sum()
	...
	public static void main(String[] args) {
		...
		// ----- test 4 -----
		p0 = new int[] { 419, 337, 853, 513, 632, 861, 336, 594, 94, 367, 336, 297, 966, 627, 399, 433, 846, 859, 80,
				2 };
		p1 = 19;
		p2 = "###################.";
