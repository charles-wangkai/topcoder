...
public class grafixCorrupt {
	public int selectWord(String[] dictionary, String candidate) {
		...
		for (int i = 0; i < dictionary.length; ++i) {
			int i_ = i;
			int sameCount = (int) IntStream.range(0, candidate.length())
					.filter(j -> candidate.charAt(j) == dictionary[i_].charAt(j)).count();
	...
	public static void main(String[] args) {
		...
		// ----- test 3 -----
		p0 = new String[] { "zkv", "izs", "fed", "waa", "ttx", "bgt", "quy", "dtq", "dgo", "yrs", "cid", "nln", "pvz",
				"txt", "zun", "erd", "jen", "klh", "kxy", "emf", "mqt", "lza", "dzb", "ndx", "vfr", "jhs", "dkm",
				"elb" };
		p1 = "cwd";
		p2 = 10;
		...
		// ----- test 4 -----
		p0 = new String[] { "zhadjsg", "vzptftx", "fbaslxs", "ejejncm", "xpxkeae", "ixrrtzw", "ovctbzx", "sfzekhh",
