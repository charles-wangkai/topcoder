...
public class TeXLeX {
  public int[] getTokens(String input) {
    ...
    while (index != input.length()) {
      ...
      char additive;
      if (caretCount == 2) {
        if (convertHexDigit(c) != -1
            && index + 1 < input.length()
            && convertHexDigit(input.charAt(index + 1)) != -1) {
          additive = (char) (convertHexDigit(c) * 16 + convertHexDigit(input.charAt(index + 1)));
          index += 2;
        } else if (c > 63) {
          additive = (char) (c - 64);
          ++index;
  ...
  public static void main(String[] args) {
    ...
    p1 =
        new int[] {
          32, 50, 30, 94, 79, 67, 35, 56, 74, 4, 113, 57, 71, 81, 112, 101, 105, 41, 95, 38, 95, 81,
          60, 0, 62, 124, 65, 76, 56, 36, 94, 94
        };
