...
public class PickTeam {
	public String[] pickPeople(int teamSize, String[] people) {
		...
		String[] result = null;
		for (int code = 0; code < (1 << peopleNum); ++code) {
			if (Integer.bitCount(code) == teamSize) {
				boolean[] chosen = decode(peopleNum, code);
				...
				if (sum > maxSum) {
					...
					result = IntStream.range(0, peopleNum).filter(i -> chosen[i]).mapToObj(i -> names[i]).sorted()
							.toArray(String[]::new);
				}
			}
		}
	...
	public static void main(String[] args) {
		...
		// ----- test 3 -----
		p0 = 13;
		p1 = new String[] { "A 0 2 8 7 1 -4 -3 1 8 2 8 2 1 -3 7 1 3 9 -6 -5",
				...
				"B -3 8 1 3 -2 4 0 8 -1 1 -2 -7 5 0 -6 9 0 -3 1 3", "B 1 -8 -3 9 -9 8 8 0 0 -2 5 0 5 8 3 5 2 4 5 4",
				"C 8 -9 1 8 3 6 -1 0 0 8 -3 8 -6 -4 7 -4 1 -5 5 4", "C 2 -9 9 3 7 0 1 -2 8 0 -9 -6 6 5 -8 -3 -8 2 2 4",
				...
				"E 9 0 6 -1 2 -7 -3 4 -5 2 -6 2 -3 -8 -5 -7 6 0 4 8", "E -6 3 -8 -2 1 6 1 5 5 2 4 -4 4 5 -8 8 0 4 0 1",
