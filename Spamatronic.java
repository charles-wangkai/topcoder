...
public class Spamatronic {
  ...
  public int[] filter(String[] knownSpam, String[] newMail) {
    Set<String> spamTokens =
        Arrays.stream(knownSpam).flatMap(s -> buildTokens(s).stream()).collect(Collectors.toSet());
  ...
  public static void main(String[] args) {
    ...
    p1 =
        new String[] {
          "Try the prime ribs.", "Donner: New Prime Rates Today", "Try the prime ribs."
        };
    p2 = new int[] {0};
